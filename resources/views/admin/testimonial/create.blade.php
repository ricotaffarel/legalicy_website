                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name') }}" id="name" name="name" placeholder="Add name">
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('job') is-invalid @enderror"
                                        value="{{ old('job') }}" id="job" name="job" placeholder="Add job">
                                    @error('job')
                                        <div class="invalid invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control @error('testimony') is-invalid @enderror" value="{{ old('testimony') }}"
                                        id="testimony" name="testimony" placeholder="Add testimony"></textarea>
                                    @error('testimony')
                                        <div class="invalid invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
