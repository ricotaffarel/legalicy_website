                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('sliders/' . $slider->image) }}" alt="" class="img-fluid" style="max-width: 200px; max-height: 100px; border-radius:0;">
                            </td>
                            <td>{{ $slider->title }}</td>
                            <td>{{ $slider->desc }}</td>
                            <td>
                                <a href="/admin/slider/{{ $slider->id }}/edit" class="btn btn-warning fw-semibold">Edit</a>
                                <form action="/admin/slider/{{$slider->id}}" method="post" class="d-inline">
                                    @csrf <!-- Fitur Security yang berfungsi supaya tidak page expired -->
                                    @method('delete')
                                  <button class="btn btn-danger fw-semibold " onclick="return confirm('Anda yakin akan menghapus data?');">Delete</button>
                                </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a id="deleteLink" type="submit" class="btn btn-primary btn-bg-gradient-x-red-pink" name="simpan" value="danger">Hapus</a>
                </div>
            </div>
        </div>
    </div>
