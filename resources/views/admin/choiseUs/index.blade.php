                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('choisesUs/' . $choise->image) }}" alt="" class="img-fluid" style="width: 100px; height: 100px; border-radius:0;">
                            </td>
                            <td>{{ $choise->title }}</td>
                            <td>{{ $choise->desc }}</td>
                            <td>
                                <a href="/admin/choiseus/{{ $choise->id }}/edit" class="btn btn-warning fw-semibold">Edit</a>
                                <form action="/admin/choiseus/{{$choise->id}}" method="post" class="d-inline">
