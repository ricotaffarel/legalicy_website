            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="/admin/choiseus/{{ $choises->id }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        value="{{ old('title', $choises->title) }}" id="title" name="title"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control @error('desc') is-invalid @enderror"
                                        value="{{ old('desc', $choises->desc) }}" id="desc" name="desc" placeholder="Add Desc">{{ old('desc', $choises->desc) }}</textarea>
                                    @error('desc')
                                        <div class="invalid invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="file-upload-info @error('image') is-invalid @enderror"
                                        value="{{ old('image', $choises->image) }}" id="image" name="image"
                                        placeholder="Masukkan Gambar">
                                    <img src="{{ asset('choisesUs/' . $choises->image) }}"
                                        class="img-preview img-fluid mt-2" id="image-preview" width="100px">
                                    @error('image')
                                        <div class="invalid invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
