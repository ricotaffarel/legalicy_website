            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ Route('admin.discount.update', $discount->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('start_at') is-invalid @enderror"
                                        value="{{ old('start_at', $discount->start_at) }}" id="start_at" name="start_at"
                                        placeholder="Add Start At">
                                    @error('start_at')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('end_at') is-invalid @enderror" value="{{ old('end_at', $discount->end_at) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="file-upload-info @error('image') is-invalid @enderror"
                                        value="{{ old('image', $discount->image) }}" id="image" name="image"
                                        placeholder="Masukkan Gambar">
                                    <img alt="" class="img-preview img-fluid mt-2" id="image-preview"
                                        width="100px" src="{{ asset('discounts/' . $discount->image) }}">
                                    @error('image')
                                        <div class="invalid invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
