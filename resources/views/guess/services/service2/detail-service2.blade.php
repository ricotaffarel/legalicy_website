...
{{-- Untuk layanan Digital Marketing --}}
    ...
    >
      <div class="container py-5">
        <h1 class="display-4 animated slideInDown mb-4">Detail Service 2</h1>
        <nav aria-label="breadcrumb animated slideInDown">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Detail Service 2</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-6 wow fadeInUp justify-content-between">
                <h1 class="display-6 mb-5 text-center ">PIRT</h1>
                <p class="mb-4">
